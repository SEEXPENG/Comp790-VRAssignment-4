...
public class ControllerCubeRight : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        OVRInput.Controller controller = OVRInput.Controller.RTouch; // Select which controller to use (RTouch for right controller)
